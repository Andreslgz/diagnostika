     ...
     <nav class="bg-header border-gray-200 px-4 xl:py-0 py-3 lg:px-6">
         <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl">
             <a href="<?php echo $url; ?>" class="flex items-center">
                 <img src="<?php echo $url; ?>/assets/icons/Logotipo.svg" class="mr-3 h-6 sm:h-9" alt="<?php echo $titulo; ?>" />
             </a>
             ...
             <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1"
                 ...
                 <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-0 lg:mt-0 lg:h-full">
                     <li class="lg:h-full lg:flex lg:items-center xl:py-3 <?php echo isActive('/') ? 'btn-secondary' : ''; ?>">
                         <a href="<?php echo $url; ?>"
                     ...
                     <li class="lg:h-full lg:flex lg:items-center xl:py-3 <?php echo isActive('/tienda') ? 'btn-secondary' : ''; ?>">
                     ...
                     <li class="lg:h-full lg:flex lg:items-center xl:py-3 <?php echo isActive('/pages/contacto.php') ? 'btn-secondary' : ''; ?>">
