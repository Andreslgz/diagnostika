            ...
            <div class="mx-auto max-w-screen-2xl px-4 2xl:px-0">
                ...
                <div class="gap-6 lg:flex ">
                                        ...
                                        <?php foreach ($marcas as $m): ?>
                                            <label class="inline-flex items-center justify-between">
                                                <span class="flex items-center">
                                                    <input type="checkbox" class="form-checkbox" name="marca[]" value="<?php echo htmlspecialchars($m['marca']); ?>" />
                                                    <span class="ml-2"><?php echo htmlspecialchars($m['marca']); ?></span>
                                                </span>
                                                <span class="ml-2 inline-flex items-center justify-center px-2 py-0.5 text-xs font-medium bg-gray-100 rounded-full">
                                                    <?php echo $m['cantidad']; ?>
                                                </span>
                                            </label>
                                        <?php endforeach; ?>
                                ...
                                <div class="flex flex-col gap-0.5">
                                    <?php if (!empty($anios)): ?>
                                        <?php foreach ($anios as $a): ?>
                                            <label class="inline-flex items-center justify-between">
                                                <span class="flex items-center">
                                                    <input type="checkbox" class="form-checkbox" name="anio[]" value="<?php echo htmlspecialchars($a['anio']); ?>" />
                    ...
                    <div class="w-full ">
                        ...
                        <nav id="paginacion" class="flex items-center justify-center py-4 mt-12" aria-label="Paginación"></nav>
